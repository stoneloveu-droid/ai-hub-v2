...
export const DB_NAME     = 'ai-hub';
export const DB_VERSION  = 2;

/** localStorage key for settings (non-sensitive) */
export const LS_SETTINGS = 'ai-hub:settings';
/** localStorage legacy key to detect old data to migrate */
export const LS_LEGACY   = 'ai_hub_v2';
...
export const SYNC_INTERVAL = 5 * 60 * 1000; // 5 min auto-sync
